...
public class GuiUtil {
	...
	private void applyPreparedAttributes(final HtmlElement cell) {
	 ...
	 */
	public String button(final String label) {
	 ...
	 * @return the id (for DOM access)
	 */
	public String checkBox(final String group, final String value, final String label, final boolean selected) {
		final String id = IdGenerator.getNextId();
	 ...
	 */
	public String labelValue(final String label, final String value) {
		final String id = IdGenerator.getNextId();
	 ...
	 * @param value
	 */
	public void prepareAttribute(final String key, final String value) {
	 ...
	 * @return the id (for DOM access)
	 */
	public String radioButton(final String group, final String value, final String label, final boolean selected) {
		final String id = IdGenerator.getNextId();
